...
from src.models.modules import LayerNorm2d, MLPBlock, Conv2d_BN, RepViTBlock, _make_divisible, PatchEmbed
...
#################################################################################
#                                                                               # 
#    Rep-ViT from https://github.com/THU-MIG/RepViT/blob/main/model/repvit.py   #
#                                                                               #
#################################################################################
...
def repvit_m1_0(**kwargs):
    ...
    return RepViT(cfgs=cfg).eval()

def repvit_m1_5(**kwargs):
    """
    Constructs a MobileNetV3-Large model
    """
    cfg = repvit_m1_5_cfgs
    return RepViT(cfgs=cfg).eval()
